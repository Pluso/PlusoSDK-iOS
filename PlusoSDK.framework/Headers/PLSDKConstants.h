 ...
 */
typedef NS_ENUM(NSInteger, PLSDKActivityType){
    /**
     *  Type rate used to allow user to rate app in AppStore
     */
    PLSDKActivityTypeRate = 0,
    /**
     *  Type share used to allow sharing ability
     */
...
extern NSString *NSStringFromPLSDKActivityType(PLSDKActivityType type);
